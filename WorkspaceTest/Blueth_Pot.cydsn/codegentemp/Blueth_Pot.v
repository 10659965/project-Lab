// ======================================================================
// Blueth_Pot.v generated from TopDesign.cysch
// 11/21/2022 at 03:33
...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("e08c806f-de79-4b9d-a454-99d29ade79a7/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("e08c806f-de79-4b9d-a454-99d29ade79a7/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
    ...
    defparam R_1.comp_name = "Potentiometer_sm1_v1_0";
    defparam R_1.port_names = "T1_1, T2_1, T2_2";
    ...
    defparam GND_1.comp_name = "Gnd_sm1_v1_0";
	...
	wire [0:0] tmpOE__PIn_Pot_net;
	wire [0:0] tmpFB_0__PIn_Pot_net;
	wire [0:0] tmpIO_0__PIn_Pot_net;
	wire [0:0] tmpINTERRUPT_0__PIn_Pot_net;
	electrical [0:0] tmpSIOVREF__PIn_Pot_net;
	...
	cy_psoc3_pins_v1_10
		...
		PIn_Pot
		 (.oe(tmpOE__PIn_Pot_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIn_Pot_net[0:0]}),
		  .analog({Net_79}),
		  .io({tmpIO_0__PIn_Pot_net[0:0]}),
		  .siovref(tmpSIOVREF__PIn_Pot_net),
		  .interrupt({tmpINTERRUPT_0__PIn_Pot_net[0:0]}),
		  .annotation({Net_3}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PIn_Pot_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_1 UART_BlueT (
        .clock(1'b0),
        .cts_n(1'b0),
        .reset(1'b0),
        .rts_n(Net_84),
        ...
        .rx_clk(Net_86),
        .rx_data(Net_87),
        .rx_interrupt(Net_113),
        .tx(Net_89),
        .tx_clk(Net_90),
        .tx_data(Net_91),
        .tx_en(Net_92),
        .tx_interrupt(Net_93));
    defparam UART_BlueT.Address1 = 0;
    defparam UART_BlueT.Address2 = 0;
    defparam UART_BlueT.EnIntRXInterrupt = 0;
    defparam UART_BlueT.EnIntTXInterrupt = 0;
    defparam UART_BlueT.FlowControl = 0;
    defparam UART_BlueT.HalfDuplexEn = 0;
    defparam UART_BlueT.HwTXEnSignal = 1;
    defparam UART_BlueT.NumDataBits = 8;
    defparam UART_BlueT.NumStopBits = 1;
    defparam UART_BlueT.ParityType = 0;
    defparam UART_BlueT.RXEnable = 1;
    defparam UART_BlueT.TXEnable = 1;

	wire [0:0] tmpOE__Rx_BlueT_net;
	wire [0:0] tmpIO_0__Rx_BlueT_net;
	wire [0:0] tmpINTERRUPT_0__Rx_BlueT_net;
	electrical [0:0] tmpSIOVREF__Rx_BlueT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_BlueT
		 (.oe(tmpOE__Rx_BlueT_net),
		  .y({1'b0}),
		  .fb({Net_85}),
		  .io({tmpIO_0__Rx_BlueT_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_BlueT_net),
		  .interrupt({tmpINTERRUPT_0__Rx_BlueT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_BlueT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_BlueT_net;
	wire [0:0] tmpFB_0__Tx_BlueT_net;
	wire [0:0] tmpIO_0__Tx_BlueT_net;
	wire [0:0] tmpINTERRUPT_0__Tx_BlueT_net;
	electrical [0:0] tmpSIOVREF__Tx_BlueT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_BlueT
		 (.oe(tmpOE__Tx_BlueT_net),
		  .y({Net_89}),
		  .fb({tmpFB_0__Tx_BlueT_net[0:0]}),
		  .io({tmpIO_0__Tx_BlueT_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_BlueT_net),
		  .interrupt({tmpINTERRUPT_0__Tx_BlueT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_BlueT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_2 Timer_ADC (
        ...
        .tc(Net_106),
        .trigger(1'b1));
    defparam Timer_ADC.CaptureCount = 2;
    defparam Timer_ADC.CaptureCounterEnabled = 0;
    defparam Timer_ADC.DeviceFamily = "PSoC5";
    defparam Timer_ADC.InterruptOnCapture = 0;
    defparam Timer_ADC.InterruptOnTC = 0;
    defparam Timer_ADC.Resolution = 8;
    defparam Timer_ADC.SiliconRevision = "0";
